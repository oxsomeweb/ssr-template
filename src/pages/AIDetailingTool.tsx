...
const AIDetailingTool = () => {
  ...
  return (
    <Layout>
      <SEO
        title="AI Detailing Preview | See Your Car Transformed | Drippy Suds"
        description="Upload a photo of your car and see what it would look like after a premium detail. Try our free AI-powered detailing visualizer — no obligation."
        canonical="https://drippysuds.com/ai-detailing"
        jsonLd={{
          "@context": "https://schema.org",
          "@type": "WebApplication",
          name: "Drippy Suds AI Detailing Preview",
          url: "https://drippysuds.com/ai-detailing",
              ...
              {!resultImage && (
                <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="space-y-4">
                  <div className="flex items-center justify-between">
                    <h2 className="font-heading text-xl font-bold text-foreground">Choose a service to preview</h2>
              ...
              {resultImage && (
                <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
                  <div className="flex items-center justify-between mb-4">
                    <h2 className="font-heading text-xl font-bold text-foreground">Before & After</h2>
                    <button onClick={resetTool} className="text-muted-foreground hover:text-foreground text-sm flex items-center gap-1">
                  ...
                  >
                    ...
                    {/* Before (clipped via clip-path so it never stretches) */}
                    <img
                      src={originalImage}
                    ...
                    {/* Labels */}
                    <div className="absolute top-3 left-3 bg-background/80 backdrop-blur-sm text-foreground text-xs font-bold uppercase tracking-widest px-3 py-1 rounded">
                      Before
                    </div>
                    <div className="absolute top-3 right-3 bg-primary/80 backdrop-blur-sm text-primary-foreground text-xs font-bold uppercase tracking-widest px-3 py-1 rounded">
                      After
                    </div>
                  </div>
                  ...
                  <AnimatePresence>
                        ...
                        <div className="relative bg-card border border-primary/30 rounded-xl p-6 md:p-8">
                          <div className="text-center mb-6">
                            ...
                            <p className="text-muted-foreground mt-1">
                              Get a free quote and we'll make it real. No pressure, no commitment.
                            </p>
                          </div>
                          <form onSubmit={handleLeadSubmit} className="grid gap-4 sm:grid-cols-3">
                            <div>
                              <Label htmlFor="lead-name" className="text-xs uppercase tracking-widest text-muted-foreground">Name</Label>
                              <Input
                                id="lead-name"
                            ...
                            <div>
                              <Label htmlFor="lead-phone" className="text-xs uppercase tracking-widest text-muted-foreground">Phone</Label>
                              <Input
                                id="lead-phone"
                                type="tel"
                            ...
                            <div>
                              <Label htmlFor="lead-email" className="text-xs uppercase tracking-widest text-muted-foreground">Email</Label>
                              <Input
                                id="lead-email"
                                type="email"
                    ...
                    {leadSubmitted && (
                      <motion.div
                        ...
                        animate={{ opacity: 1, scale: 1 }}
                        className="mt-8 bg-card border border-primary/30 rounded-xl p-8 text-center"
                      >
                        ...
                        <p className="text-muted-foreground">
                          We'll reach out shortly with a personalized quote. In the meantime, feel free to{" "}
                          <a href="/s/appointments" className="text-primary hover:underline">book directly</a>.
                        </p>
                      </motion.div>
                    )}
                  </AnimatePresence>
...
export default AIDetailingTool;
